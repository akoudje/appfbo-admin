...
import { Copy, ExternalLink, Link as LinkIcon, Search, Send } from "lucide-react";
            ...
            <table className="min-w-full text-sm">
              ...
              <tbody>
                ...
                {!links.length && !loading ? (
                  <tr>
                    <td colSpan={7} className="px-3 py-8 text-center text-gray-500">Aucun lien externe.</td>
                  </tr>
                ) : null}
                {loading ? (
                  <tr>
                    <td colSpan={7} className="px-3 py-8 text-center text-gray-500">Chargement...</td>
                  </tr>
                ) : null}
              </tbody>
            </table>
